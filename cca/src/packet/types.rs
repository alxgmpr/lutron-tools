...
impl PacketType {
    ...
    pub fn is_button(&self) -> bool {
        matches!(
            self,
            Self::ButtonShortA | Self::ButtonLongA | Self::ButtonShortB | Self::ButtonLongB
        )
    }
    ...
    pub fn is_pairing(&self) -> bool {
        matches!(
            self,
            Self::PairingB8 | Self::PairingB9 | Self::PairingBA | Self::PairingBB | Self::PairingB0
        )
    }

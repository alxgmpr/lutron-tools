...
inline int cca_check_crc_at_lengths(const uint8_t* bytes, size_t bytes_len, const size_t* candidates,
                                    size_t n_candidates)
{
...
inline int cca_recover_n81_errors(uint8_t* bytes, size_t bytes_len, const size_t* candidates, size_t n_candidates,

...
pub extern "C" fn cca_packet_type_name(pkt_type: u8) -> *const c_char {
    let name = match PacketType::from_byte(pkt_type) {
        ...
        PacketType::PairingB0 => "DIMMER_DISC\0",
        ...
        PacketType::HandshakeC1 => "HS_C1\0",
        PacketType::HandshakeC2 => "HS_C2\0",
        PacketType::HandshakeC7 => "HS_C7\0",
        PacketType::HandshakeC8 => "HS_C8\0",
        PacketType::HandshakeCD => "HS_CD\0",
        PacketType::HandshakeCE => "HS_CE\0",
        PacketType::HandshakeD3 => "HS_D3\0",
        PacketType::HandshakeD4 => "HS_D4\0",
        PacketType::HandshakeD9 => "HS_D9\0",
        PacketType::HandshakeDA => "HS_DA\0",
        PacketType::HandshakeDF => "HS_DF\0",
        PacketType::HandshakeE0 => "HS_E0\0",

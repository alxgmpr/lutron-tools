...
- `docs/qsm-firmware-re.md` — QSM (Smart Bridge) complete analysis: trampoline table, TDMA timing, 8N1 codec, CRC, CC1101 config, packet dispatch, frequency hopping
- `docs/claude-context/esn-firmware-analysis.md` — ESN (Energi Savr Node) analysis
- `docs/cca-protocol.md` — CCA protocol reference built from RE findings
- `docs/firmware-update-infra.md` — How firmware update delivery works

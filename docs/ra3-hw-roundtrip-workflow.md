...
Use `/Users/alexgompper/lutron-tools/tools/sql/project-modelid-convert-ra3-hw.sql` for this path.

## Mapping rules
Implemented in `/Users/alexgompper/lutron-tools/tools/sql/project-modelid-convert-ra3-hw.sql`:
...
Run `/Users/alexgompper/lutron-tools/tools/sql/project-modelid-convert-ra3-hw.sql` with:
- `@Direction = 'RA3_TO_HW'`
- `@DryRun = 1`
- `@FailOnUnmapped = 1`
...
- Do not use `/Users/alexgompper/lutron-tools/tools/sql/project-mode-convert-ra3-hw.sql` if the goal is IDs-only testing.
- Do not use `/Users/alexgompper/lutron-tools/tools/sql/project-mode-flip-metadata-only.sql` for this path.

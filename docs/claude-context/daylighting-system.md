---
name: Daylighting System Architecture
description: Full reverse engineering of Lutron daylighting data model in Designer DB — two systems (Hyperion for shades, light-level for dimmers), scaffolding auto-created but light-level control not activated on RA3/HW
type: project
---
...
- `tblHyperionSettings` (ID 84): work surface 30", max sun penetration 60", max 5 shade moves/day, 30min min between moves, civil twilight -6°
- `tblFacade` (IDs 5-12): 8 compass orientations at 45° intervals (0°, 45°, 90°... 315°)

...
This is Gate 3 of the RA3-to-HW model validation. See `docs/ra3-to-hw-migration.md` for the full set of validation gates and the device migration workflow.

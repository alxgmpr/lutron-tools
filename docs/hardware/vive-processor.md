...
Note: This document is for the standalone legacy `Vive.app` bundle only. See `docs/hardware/vive-athena.md` for follow-up findings showing Athena/LEAP route families in the unified `Lutron` app lineage.
...
Compared against `docs/protocols/leap.md` (Route Reference section):

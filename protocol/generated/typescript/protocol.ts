...
export const PacketType = {
  ...
  STATE_RPT_81: 129,
  /** State report (type 82, cycles 81→82→83) */
  STATE_RPT_82: 130,
...
export const PacketTypeInfo: Record<number, PacketTypeInfo> = {
  ...
  [129]: {
    ...
    length: 24,
    category: 'STATE',
    description: 'State report (type 81, cycles 81→82→83)',
    usesBigEndianDeviceId: false,
    isVirtual: false,
...
export const PacketFields: Record<string, FieldDef[]> = {
  ...
  'STATE_RPT_81': [
    ...
    },
    {
      ...
      size: 1,
      format: 'hex',
      description: '0x08 = periodic state report',
    },
    {
      name: 'level',
      offset: 11,
      size: 1,
      format: 'level_byte',
      description: 'Light output level (0x00=off)',
    },
    {
      name: 'slider_level',
      offset: 15,
      size: 1,
      format: 'level_byte',
      description: 'Slider/preset level (position even when off)',
    },
    {
      name: 'crc',
      offset: 22,
